...
const CampSite = ({title, subtitle, peopleJoined}: CampProps) =>{
    return(
        <div className="h-full w-full min-w-[1100px] bg-[url('/Images/img-1.png')] 
        bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl">
            <div className='flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10'>
                <div className='flexCenter gap-4'>
                    <div className='rounded-full bg-green-50 p-4'>
                        <Image src="/Images/folded-map.svg"
                        alt='map'
                        width={28}
                        height={28}/>
                    </div>
                ...
                <div className='flexCenter gap-6'>
                    <span className='flex -soace-x-4 overflow-hidden'>
...
const CampSite2 = ({title, subtitle, peopleJoined}: CampProps) =>{
    return(
        <div className="h-full w-full min-w-[1100px] bg-[url('/Images/img-2.png')] 
        bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl">
            <div className='flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10'>
                <div className='flexCenter gap-4'>
                    <div className='rounded-full bg-green-50 p-4'>
