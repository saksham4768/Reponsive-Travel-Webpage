  ...
  return (
    ...
    gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
        ...
        <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
            <Image src="/Images/camp.svg"
            alt='camp'
            width={50}
            height={50}
            className='absolute left-[-5px] top-[-48px] w-10 lg:w-[50px]'/>
            <h1 className='bold-52 lg:bold-60'>Uniquely Peaceful, Beautifully Reastful.</h1>
            <p className='regular-16 mt-6 text-gray-30 xl:max-w-[520px]'>
                We want to be on each of your journeys seeking the satisfaction of seeing the incorruptible beauty of nature. We can help you on an 
